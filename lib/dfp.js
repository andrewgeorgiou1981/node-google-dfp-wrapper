...
Dfp.prototype.getCreativeTemplates = function(conditions) {
  var service = 'CreativeTemplateService';
  var method = 'getCreativeTemplatesByStatement';
...
Dfp.prototype.getCreativeWrappers = function(conditions) {
  var service = 'CreativeWrapperService';
  var method = 'getCreativeWrappersByStatement';
...
//
// Dfp.prototype.updateCreativeWrappers = function(conditions) {
//   var service = 'CreativeWrapperService';
//   var method = 'getCreativeCreativeWrappersByStatement';
//
//   var query = _makeQuery(conditions, LINE_ITEM_FIELDS);
//
//   return this.dfpUser.executeAPIFunction(service, method, query)
...
Dfp.prototype.getCriteriaValues = function(conditions) {
  var service = 'CustomTargetingService';
  var method = 'updateCreativeWrappers';
